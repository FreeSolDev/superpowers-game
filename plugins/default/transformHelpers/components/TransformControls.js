...
class TransformControls extends THREE.Object3D {
    ...
    set camera(value) {
        if (this._camera !== value) {
            this._camera = value;
            this.dispatchEvent({ type: "camera-changed", value: value });
    ...
    set object(value) {
        if (this._object !== value) {
            this._object = value;
            this.dispatchEvent({ type: "object-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set enabled(value) {
        if (this._enabled !== value) {
            this._enabled = value;
            this.dispatchEvent({ type: "enabled-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set axis(value) {
        if (this._axis !== value) {
            this._axis = value;
            this.dispatchEvent({ type: "axis-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set mode(value) {
        if (this._mode !== value) {
            this._mode = value;
            this.dispatchEvent({ type: "mode-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get translationSnap() { return this._translationSnap; }
    set translationSnap(value) {
        if (this._translationSnap !== value) {
            this._translationSnap = value;
            this.dispatchEvent({ type: "translationSnap-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get rotationSnap() { return this._rotationSnap; }
    set rotationSnap(value) {
        if (this._rotationSnap !== value) {
            this._rotationSnap = value;
            this.dispatchEvent({ type: "rotationSnap-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get scaleSnap() { return this._scaleSnap; }
    set scaleSnap(value) {
        if (this._scaleSnap !== value) {
            this._scaleSnap = value;
            this.dispatchEvent({ type: "scaleSnap-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set space(value) {
        if (this._space !== value) {
            this._space = value;
            this.dispatchEvent({ type: "space-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set size(value) {
        if (this._size !== value) {
            this._size = value;
            this.dispatchEvent({ type: "size-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    get showX() { return this._showX; }
    set showX(value) {
        if (this._showX !== value) {
            this._showX = value;
            this.dispatchEvent({ type: "showX-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get showY() { return this._showY; }
    set showY(value) {
        if (this._showY !== value) {
            this._showY = value;
            this.dispatchEvent({ type: "showY-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get showZ() { return this._showZ; }
    set showZ(value) {
        if (this._showZ !== value) {
            this._showZ = value;
            this.dispatchEvent({ type: "showZ-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set worldPosition(value) {
        if (this._worldPosition !== value) {
            ...
            this.dispatchEvent({ type: "worldPosition-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get worldPositionStart() { return this._worldPositionStart; }
    set worldPositionStart(value) {
        if (this._worldPositionStart !== value) {
            this._worldPositionStart = value;
            this.dispatchEvent({ type: "worldPositionStart-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set worldQuaternion(value) {
        if (this._worldQuaternion !== value) {
            ...
            this.dispatchEvent({ type: "worldQuaternion-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get worldQuaternionStart() { return this._worldQuaternionStart; }
    set worldQuaternionStart(value) {
        if (this._worldQuaternionStart !== value) {
            this._worldQuaternionStart = value;
            this.dispatchEvent({ type: "worldQuaternionStart-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set cameraPosition(value) {
        if (this._cameraPosition !== value) {
            ...
            this.dispatchEvent({ type: "cameraPosition-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get cameraQuaternion() { return this._cameraQuaternion; }
    set cameraQuaternion(value) {
        if (this._cameraQuaternion !== value) {
            this._cameraQuaternion = value;
            this.dispatchEvent({ type: "cameraQuaternion-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get pointStart() { return this._pointStart; }
    set pointStart(value) {
        if (this._pointStart !== value) {
            this._pointStart = value;
            this.dispatchEvent({ type: "pointStart-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    get pointEnd() { return this._pointEnd; }
    set pointEnd(value) {
        if (this._pointEnd !== value) {
            this._pointEnd = value;
            this.dispatchEvent({ type: "pointEnd-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set rotationAxis(value) {
        if (this._rotationAxis !== value) {
            ...
            this.dispatchEvent({ type: "rotationAxis-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set rotationAngle(value) {
        if (this._rotationAngle !== value) {
            ...
            this.dispatchEvent({ type: "rotationAngle-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    set eye(value) {
        if (this._eye !== value) {
            this._eye = value;
            this.dispatchEvent({ type: "eye-changed", value: value });
            this.dispatchEvent(_changeEvent);
        }
    }
    ...
    updateMatrixWorld(force) {
        ...
        for (let i = 0; i < handles.length; i++) {
            ...
            if (this.ctrl.camera.type === "OrthographicCamera")
                factor = (this.ctrl.camera.top - this.ctrl.camera.bottom) / this.ctrl.camera.zoom;
            else
                factor = this.ctrl.worldPosition.distanceTo(this.ctrl.cameraPosition) * Math.min(1.9 * Math.tan(Math.PI * this.ctrl.camera.fov / 360) / this.ctrl.camera.zoom, 7);
...
class TransformControlsPlane extends THREE.Mesh {
    constructor(ctrl) {
        super(new THREE.PlaneGeometry(100000, 100000, 2, 2), new THREE.MeshBasicMaterial({ visible: false, wireframe: true, side: THREE.DoubleSide, transparent: true, opacity: 0.1, toneMapped: false }));
        this.ctrl = ctrl;
